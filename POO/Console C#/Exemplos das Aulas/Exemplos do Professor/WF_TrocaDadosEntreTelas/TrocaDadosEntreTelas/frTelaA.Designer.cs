namespace TrocaDadosEntreTelas
{
  partial class frTelaA
  {
    ...
    private void InitializeComponent()
    {
      ...
      // txtRetorno
      // 
      this.txtRetorno.Location = new System.Drawing.Point(176, 104);
      ...
      this.button1.Text = "Abre a tela b";
      ...
      this.Name = "frTelaA";
      this.Text = "Tela-A";
      this.Load += new System.EventHandler(this.frTelaA_Load);
